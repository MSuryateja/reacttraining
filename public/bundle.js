...
/***/ (function(module, exports, __webpack_require__) {
	...
	var nameReducer = function nameReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { name: 'Ananymous' };
	    var action = arguments[1];
	...
	var hobbiesReducer = function hobbiesReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { hobbies: [] };
	    var action = arguments[1];
	...
	var deptsReducer = function deptsReducer() {
	    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { depts: [] };
	    var action = arguments[1];

	    switch (action.type) {
	        case 'ADD_DEPT':
	            return _extends({}, state, {
	                depts: [].concat(_toConsumableArray(state.depts), [{
	                    id: adddept++,
	                    dept: action.dept
	                }])
	            });
	...
	var us = store.subscribe(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(194);
